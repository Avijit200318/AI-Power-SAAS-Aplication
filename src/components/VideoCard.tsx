...
// we need relative time to know when we upload our file
...
export const VideoCard: React.FC<VideoCardProps> = ({ video, onDownload }) => {
  ...
  // how we will get the thumbnail url. we need its publicId
  const getThumbnailUrl = useCallback((publicId: string) => {
    return getCldImageUrl({
      ...
      quality: "auto",
      assetType: "video"
      // this assetType create a image thumbnail for video asset
    })
  }, [])
  ...
  const getPreviewVideoUrl = useCallback((publicId: string) => {
    return getCldVideoUrl({
      ...
      // go to docs to understand this more clearly
    })
  }, [])
